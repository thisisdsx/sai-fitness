...
?>
<div class="container-fluid" style="margin-top:10%;" id="parent">
...
<button id="download" class="btn btn-info" onclick="PrintDiv()" name="download" style="border-radius:5px;padding:7px;color:white;font-weight:700;border:2px solid black;width:100%;">Download</button>
</div></div></div>
</body>
</html>
